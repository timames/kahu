...
_register(ConnectorType(
    ...
    fields=(
        ConnectorField("server_address", "Server / Domain Controller IP", placeholder="192.168.1.10"),
        ConnectorField("username", "Domain Admin Username", placeholder="DOMAIN\\Administrator"),
...
_register(ConnectorType(
    ...
    icon="\U0001f427",  # 🐧
    auth_method="credentials",
    description="System logs, auth logs, and application logs from Linux hosts via Wazuh agent.",
    ...
    fields=(
        ...
        ConnectorField("auth_type", "Auth Method", field_type="select", placeholder="password,ssh_key"),
...
_register(ConnectorType(
    ...
    fields=(
        ...
        ConnectorField("api_key", "API Key", field_type="password",
...
_register(ConnectorType(
    ...
    fields=(
        ...
        ConnectorField("api_key", "REST API Key", field_type="password",
...
_register(ConnectorType(
    ...
    fields=(
        ConnectorField("api_key", "Dashboard API Key", field_type="password",
...
_register(ConnectorType(
    ...
    fields=(
        ConnectorField("controller_url", "Controller URL", placeholder="https://unifi.local:8443"),
        ConnectorField("username", "Admin Username", placeholder="admin"),
        ConnectorField("password", "Password", field_type="password"),
    ),
))
...
_register(ConnectorType(
    ...
    fields=(
        ConnectorField("tenant_id", "Tenant ID", placeholder="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"),
        ConnectorField("client_id", "Application (Client) ID", placeholder="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"),
...
_register(ConnectorType(
    ...
    fields=(
        ConnectorField("customer_id", "Customer ID", placeholder="C0xxxxxxx",
                       help_text="Admin console > Account > Account settings"),
        ConnectorField("service_account_json", "Service Account Key (JSON)", field_type="textarea",
...
_register(ConnectorType(
    ...
    fields=(
        ...
        ConnectorField("trail_name", "Trail Name", required=False, placeholder="management-events"),
    ),
))
...
_register(ConnectorType(
    ...
    icon="\u2601\ufe0f",  # ☁️
    auth_method="credentials",
    description="Azure resource operations, policy events, and service health from Azure Monitor.",
    events_per_day="1K–100K",
    setup_guide_url="https://learn.microsoft.com/en-us/entra/identity-platform/quickstart-register-app",
    fields=(
        ConnectorField("tenant_id", "Tenant ID", placeholder="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"),
        ConnectorField("client_id", "Application (Client) ID", placeholder="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"),
        ConnectorField("client_secret", "Client Secret", field_type="password"),
        ConnectorField("subscription_id", "Subscription ID", placeholder="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"),
    ),
))
...
_register(ConnectorType(
    ...
    fields=(
        ...
        ConnectorField("api_token", "API Token", field_type="password",
...
_register(ConnectorType(
    ...
    fields=(
        ConnectorField("api_hostname", "API Hostname", placeholder="api-XXXXXXXX.duosecurity.com"),
...
_register(ConnectorType(
    ...
    icon="\U0001f6e1\ufe0f",  # 🛡️
    auth_method="api_key",
    description="Threat detections, agent activity, and deep visibility events from SentinelOne.",
    events_per_day="5K–100K",
    setup_guide_url="https://usea1-partners.sentinelone.net/docs/en/generating-api-tokens.html",
    fields=(
        ConnectorField("console_url", "Console URL", placeholder="https://usea1.sentinelone.net"),
        ConnectorField("api_token", "API Token", field_type="password",
...
_register(ConnectorType(
    ...
    fields=(
        ...
        ConnectorField("client_secret", "API Client Secret", field_type="password",
                       help_text="Support and resources > API Clients and Keys"),
        ConnectorField("base_url", "CrowdStrike Cloud", field_type="select",
...
_register(ConnectorType(
    ...
    fields=(
        ConnectorField("source_name", "Source Name", placeholder="lobby-switch-01",
                       help_text="A friendly name for this source"),
        ConnectorField("syslog_port", "Syslog Port", placeholder="514"),
        ConnectorField("protocol", "Protocol", field_type="select", placeholder="udp,tcp,tcp+tls"),
    ),
))
