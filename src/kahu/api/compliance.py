        ...
        "families": {
            ...
            "3.3": {
                ...
                "controls": [
                    ...
                    },
                    {
                        ...
                        "tags": ["audit_logging", "correlation"],
                    },
                ],
            },
            "3.4": {
                ...
                "controls": [
                    ...
                    },
                    {
                        ...
                        "tags": ["access_control", "configuration"],
                    },
                ],
            },
            "3.5": {
                ...
                "controls": [
                    ...
                    {
                        "id": "3.5.2",
                        "title": "Authenticate users and processes",
                        "tags": ["authentication", "mfa"],
                    },
                    {
                        "id": "3.5.3",
                        "title": "Use multifactor authentication for network access",
            ...
            "3.6": {
                ...
                "controls": [
                    ...
                    {
                        "id": "3.6.3",
                        "title": "Test the incident response capability",
                        "tags": ["incident_response", "testing"],
                    },
                ],
            },
            "3.11": {
                ...
                "controls": [
                    ...
                    },
                    {
                        ...
                        "tags": ["vulnerability_scan", "risk_assessment"],
                    },
                    {
                        "id": "3.11.3",
                        "title": "Remediate vulnerabilities in accordance with risk",
                        "tags": ["vulnerability_management", "remediation"],
                    },
                ],
            },
            "3.12": {
                ...
                "controls": [
                    {
                        ...
                        "tags": ["network_monitoring", "boundary_protection"],
                    },
                    {
                        "id": "3.13.5",
        ...
        "families": {
            "164.312(a)": {
                ...
                "controls": [
                    {
                        "id": "164.312(a)(1)",
                        "title": "Implement access controls for ePHI",
                        "tags": ["access_control"],
                    },
                    {
                        "id": "164.312(a)(2)(i)",
            ...
            "164.312(b)": {
                ...
                "controls": [
                    {
                        "id": "164.312(b)",
                        "title": "Implement audit controls to record and examine activity",
                        "tags": ["audit_logging", "monitoring"],
                    },
                ],
            },
                ...
                "controls": [
                    {
                        ...
                        "tags": ["integrity", "data_protection"],
                    },
                ],
            },
            "164.312(d)": {
                ...
                "controls": [
                    {
                        "id": "164.312(d)",
                        "title": "Verify identity of persons seeking access to ePHI",
                        "tags": ["authentication", "mfa"],
                    },
                ],
            },
                ...
                "controls": [
                    {
                        ...
                        "tags": ["encryption", "network_monitoring"],
                    },
                    {
                        "id": "164.312(e)(2)(ii)",
            ...
            "CIS-13": {
                ...
                "controls": [
                    ...
                    },
                    {
                        ...
                        "tags": ["network_monitoring", "netflow"],
                    },
                ],
            },
            "CIS-17": {
        ...
        "families": {
            ...
            "CC2": {
                ...
                "controls": [
                    {
                        "id": "CC2.1",
                        "title": "Internally generated information for system controls",
                        "tags": ["audit_logging", "monitoring"],
                    },
                    {
                        "id": "CC2.2",
                        "title": "Internal communication of control objectives",
                        "tags": ["governance"],
                    },
                    {
                        "id": "CC2.3",
                        "title": "External communication of matters affecting controls",
                        "tags": ["incident_response", "evidence"],
                    },
                ],
            },
            "CC3": {
                ...
                "controls": [
                    {
                        "id": "CC3.1",
                        "title": "Identification of objectives and risk tolerance",
                        "tags": ["risk_assessment"],
                    },
                    {
                        "id": "CC3.2",
                        "title": "Risk identification and analysis",
                        "tags": ["risk_assessment", "vulnerability_scan"],
                    },
                    {
                        "id": "CC3.3",
                        "title": "Consider potential for fraud",
                        "tags": ["anomaly_detection", "risk_assessment"],
                    },
                    {
                        "id": "CC3.4",
                        "title": "Identification and assessment of changes",
            ...
            "CC4": {
                ...
                "controls": [
                    {
                        "id": "CC4.1",
                        "title": "Ongoing and/or separate evaluations of controls",
                        "tags": ["continuous_monitoring", "security_assessment"],
                    },
                    {
                        "id": "CC4.2",
                        "title": "Communicate control deficiencies timely",
                        "tags": ["incident_response", "monitoring"],
                    },
                ],
            },
            "CC5": {
                ...
                "controls": [
                    ...
                    {
                        "id": "CC5.2",
                        "title": "Technology general controls selection",
                        "tags": ["access_control", "configuration"],
                    },
                    {
                        "id": "CC5.3",
                        "title": "Deployment of control activities through policies",
            ...
            "CC6": {
                ...
                "controls": [
                    {
                        "id": "CC6.1",
                        "title": "Logical access security software, infrastructure, architectures",
                        "tags": ["access_control", "authentication"],
                    },
                    {
                        "id": "CC6.2",
                        "title": "User registration and authorization",
                        "tags": ["identity", "access_control"],
                    },
                    {
                        "id": "CC6.3",
                    ...
                    {
                        "id": "CC6.6",
                        "title": "System boundary security measures",
                        "tags": ["network_monitoring", "boundary_protection"],
                    },
                    {
                        "id": "CC6.7",
                        "title": "Restrict data movement to authorized users",
            ...
            "CC7": {
                ...
                "controls": [
                    {
                        "id": "CC7.1",
                        "title": "Detection and monitoring of infrastructure and software",
                        "tags": ["monitoring", "siem"],
                    },
                    {
                        "id": "CC7.2",
                    ...
                    {
                        "id": "CC7.3",
                        "title": "Evaluate security events for incidents",
                        "tags": ["triage", "incident_response"],
                    },
                    {
                        "id": "CC7.4",
                    ...
                    {
                        "id": "CC7.5",
                        "title": "Identify and communicate containment/remediation activities",
                        "tags": ["incident_response", "remediation"],
                    },
                ],
            },
            "CC8": {
                ...
                "controls": [
                    {
                        "id": "CC8.1",
                        "title": (
                            "Authorize, design, develop, configure,"
                            " document, test, approve changes"
                        ),
                        "tags": ["configuration", "change_management"],
                    },
                ],
            },
            "CC9": {
                ...
                "controls": [
                    {
                        "id": "CC9.1",
                        "title": "Identify and assess risk mitigation activities",
                        "tags": ["risk_assessment", "vulnerability_management"],
                    },
                    {
                        "id": "CC9.2",
                        "title": "Assess and manage risks from vendors and partners",
                        "tags": ["risk_assessment"],
                    },
                ],
            },
            "A1": {
                ...
                "controls": [
                    {
                        "id": "A1.1",
                        "title": "Maintain, monitor, and evaluate processing capacity",
                        "tags": ["monitoring", "continuous_monitoring"],
                    },
                    {
                        "id": "A1.2",
                        "title": "Provide recovery of infrastructure and data",
                        "tags": ["incident_response"],
                    },
                ],
            },
...
@router.get("/profiles")
async def list_profiles(session: AsyncSession = Depends(get_session)) -> dict:  # noqa: B008
...
async def activate_profile(
    ...
    existing = await session.scalar(
        select(ComplianceProfile).where(ComplianceProfile.framework_id == body.framework_id)
    )
    if existing:
...
async def deactivate_profile(
    ...
    result = await session.execute(
        select(ComplianceProfile).where(ComplianceProfile.framework_id == framework_id)
    )
...
async def get_evidence(
    framework_id: str | None = Query(None),  # noqa: B008
    control_id: str | None = Query(None),  # noqa: B008
    ...
    # If a specific control_id is given, filter for records
    # containing that control tag
    if control_id:
        # Match evidence records whose control_tags array contains
        # a tag starting with the control id
    ...
    elif framework_id and framework_id in FRAMEWORKS:
        ...
        tag_filters = [EvidenceRecord.control_tags.cast(String).contains(tag) for tag in all_tags]
        if tag_filters:
...
async def evidence_summary(
    ...
    # Count by event_type
    type_stmt = select(EvidenceRecord.event_type, sa_func.count()).group_by(
        EvidenceRecord.event_type
    )
    ...
    latest = await session.scalar(
        select(EvidenceRecord.timestamp).order_by(desc(EvidenceRecord.timestamp)).limit(1)
    )
